...
//Headline
  static TextStyle headline1 = const TextStyle(
      fontWeight: FontWeight.bold, fontSize: 32, fontFamily: defaultFontFamily);

  static TextStyle headline2 = const TextStyle(
      fontWeight: FontWeight.bold, fontSize: 28, fontFamily: defaultFontFamily);

  static TextStyle headline3 = const TextStyle(
      fontWeight: FontWeight.bold, fontSize: 26, fontFamily: defaultFontFamily);
