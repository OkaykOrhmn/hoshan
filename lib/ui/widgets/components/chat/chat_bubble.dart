    ...
    return Directionality(
      ...
      child: Padding(
        padding: EdgeInsets.fromLTRB(
            message.fromBot! ? 16 : 32, 0, message.fromBot! ? 32 : 16, 16),
        child: Column(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(10).copyWith(
                    topRight: Radius.circular(message.fromBot! ? 10 : 0),
                    bottomLeft: Radius.circular(message.fromBot! ? 0 : 10)),
              ),
              padding: const EdgeInsets.all(16),
              child: BlocProvider<SendMessageBloc>(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              padding:
                                                  const EdgeInsets.symmetric(
                                                      horizontal: 10.0),
                                              child: Assets.icon.outline.like
                                                  .svg(
                                                      color: message.fromBot!
                                                          ? AppColors
                                                              .primaryColor
            ...
            Row(
              mainAxisAlignment: message.fromBot!
